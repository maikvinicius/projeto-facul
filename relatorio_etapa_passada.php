<?php
  ...
  $consulta = "SELECT U.nome AS usuario, count(IE.FK_Usuario_codigo) AS quantidade 
  FROM Item_Etapa AS IE
  INNER JOIN Usuario AS U ON (U.codigo = IE.FK_Usuario_codigo)
  WHERE data_final IS NOT NULL AND IE.empresa='{$_SESSION["empresa"]}'
  GROUP BY IE.FK_Usuario_codigo;";
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <table class="table">
                  <thead>
                    <th>Usuário</th>
                    <th>Quantidade de etapas finalizadas</th>
                  </thead>
                  <tbody>
                      <?php
