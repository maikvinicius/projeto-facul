      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Categoria de Clientes</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="cliente_add_categoria.php?id=<?php echo $id; ?>">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-primary">
                            <a href="categorias_clientes_view.php?id=<?php echo $id; ?>&excluir=<?php echo $row['categoria_codigo']; ?>">
