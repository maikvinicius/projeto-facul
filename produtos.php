<?php
	...
	$consulta = "SELECT * FROM Produto WHERE empresa = '{$_SESSION["empresa"]}';";
  $result = mysqli_query($conn, $consulta);

  
  havePermission($conn, 'produto', 'produto_visualizar');
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="video.php?video=produtos">Ajuda cadastro/editar</a>
            <a class="navbar-brand" href="video.php?video=importar_csv_produtos">Ajuda CSV</a>
          </div>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-primary">
                            <a href="produto.php?id=<?php echo $row['codigo']; ?>">
                              <button class="btn btn-primary">Editar</button>
                            </a>
                            <a href="categorias_produtos_view.php?id=<?php echo $row['codigo']; ?>">
