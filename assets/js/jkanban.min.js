! function e(n, t, o) {
      ...
      ! function() {
          this.jKanban = function() {
              ...
              this.element = "", this.container = "", this.boardContainer = [], this.dragula = o, this.drake = "", this.drakeBoard = "", this.addItemButton = !1, this.buttonContent = "+", defaults = {
                  ...
                  ! function() {
                  ...
                  }), e.drake = e.dragula(e.boardContainer, function() {}).on("drag", function(n, t) {
                      ...
                      if (a.length > 0 && void 0 !== a)
                          for (var d = 0; d < a.length; d++) a[d].classList.remove("disabled-board");
      ...
      n.exports = function(e, n) {
          ...
          return void 0 === e && (e = {}), e.on = function(n, t) {
              ...
              return function() {
                  var i = o(arguments),
                      d = this || e;
                  if ("error" === n && !1 !== t.throws && !a.length) throw 1 === i.length ? i[0] : i;
  ...
  9: [function(e, n, t) {
      (function(t) {
          ...
          function y(e, n) {
              var t, o = (t = n, t.targetTouches && t.targetTouches.length ? t.targetTouches[0] : t.changedTouches && t.changedTouches.length ? t.changedTouches[0] : t),
                  r = {
                      pageX: "clientX",
                      pageY: "clientY"
                  };
          ...
          n.exports = function(e, n) {
                  ...
                  if (O)
                      if (0 !== u(e)) {
                          if (void 0 === e.clientX || e.clientX !== k || void 0 === e.clientY || e.clientY !== x) {
                              ...
                              C = y("pageX", e) - s.left, S = y("pageY", e) - s.top, i.add(T || w, "gu-transit"),
                                  function() {
                                      if (!t) {
                  ...
                  if (t) {
                      ...
                      if (c !== E || !T || q.copySortSource) {
                          ...
                          if (null !== p) f = ee(c, p, n, o);
                              ...
                              if (!0 !== q.revertOnSpill || T) return void(T && l && l.removeChild(a));
                              f = B, c = E
              ...
              function ee(e, n, t, o) {
                  ...
                  return n !== e ? function() {
                      ...
                      for (n = 0; n < d; n++) {
                          if (i = e.children[n], a = i.getBoundingClientRect(), r && a.left + a.width / 2 > t) return i;
