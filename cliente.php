                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <option value="2" <?php echo ($row['captacao'] == 1) ? "selected" : "" ?>>E-mail</option>
                          <option value="3" <?php echo ($row['captacao'] == 1) ? "selected" : "" ?>>Site</option>
                          <option value="4" <?php echo ($row['captacao'] == 1) ? "selected" : "" ?>>Indicação</option>
                          <option value="5" <?php echo ($row['captacao'] == 1) ? "selected" : "" ?>>Orgânico</option>
                          </select>
                        </div>
                      </div>
                    </div>
