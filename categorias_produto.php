<?php
    ...
    havePermission($conn, 'cat_produto', 'cat_produto_editar');
      ...
      if(isset($_POST['status'])){
        $status = "1";
			...
			$sql = "UPDATE Categoria_Produto SET nome='{$nome}', 
                                 status='{$status}'  
      ...
      header('Location: categorias_produtos.php');
		...
		$consulta = "SELECT * FROM Categoria_Produto WHERE empresa = '{$_SESSION["empresa"]}' AND codigo ='{$id}'";
    ...
    if(isset($_POST['status'])){
      $status = "1";
		...
		$sql = "INSERT INTO Categoria_Produto (nome, status, empresa)
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Categorias de Produtos</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Cadastrar Categoria de Produtos</h4>
                  <p class="card-category">Informe os dados da categoria!</p>
                </div>
                <div class="card-body">
