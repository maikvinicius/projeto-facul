<?php
  ...
  havePermission($conn, 'usuario', 'usuario_visualizar');
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="video.php?video=colaborador">Ajuda cadastro/editar</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Todos os usuários que podem utilizar o sistema</p>
                </div>
                <div class="card-body">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-primary">
                            <a href="usuario.php?id=<?php echo $row['codigo']; ?>">
