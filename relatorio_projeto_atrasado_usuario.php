<?php
  ...
  $consulta = "SELECT V.codigo as projeto, U.nome as usuario, E.nome as etapa, V.data_final as prazo, IE.data_final
  FROM (SELECT * FROM Etapa WHERE ultima='1' AND empresa = '{$_SESSION["empresa"]}') AS etapa, Venda AS V
  INNER JOIN Item_Etapa AS IE ON (IE.FK_Venda_codigo = V.codigo)
  INNER JOIN Etapa AS E ON (E.codigo = IE.FK_Etapa_codigo)
  INNER JOIN Usuario AS U ON (IE.FK_Usuario_codigo = U.codigo)
  WHERE IE.data_final > V.data_final AND V.empresa = '{$_SESSION["empresa"]}' AND E.ordem = etapa.ordem-1;";
                      ...
                      <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="venda.php?id=<?php echo $row['projeto']; ?>">
